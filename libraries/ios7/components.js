...
prx.types.ios10_widget = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .ios10-widget-title-bar { height: '+(32*prx.componentsHelper.getScale(_library))+'px; background-color: '+prx.componentsHelper.getProp(item.titleBackgroundColor,'color-background')+'; border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'num-border-radius')+'px '+prx.componentsHelper.getProp(item.borderRadius,'num-border-radius')+'px 0px 0px; }';
        ...
        cR += '#'+_id+' .ios10-widget-content { height: '+(_dims.height - (32*prx.componentsHelper.getScale(_library)))+'px; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; border-radius: 0px 0px '+prx.componentsHelper.getProp(item.borderRadius,'num-border-radius')+'px '+prx.componentsHelper.getProp(item.borderRadius,'num-border-radius')+'px; }';
